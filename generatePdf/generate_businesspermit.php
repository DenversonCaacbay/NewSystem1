         ...
         <u style="font-size:18px; font-weight: bold;"> ' . $result["houseno"] . ' ' . $result["street"] . ' '. $result["brgy"] .', Olongapo City</u><br>
          ...
          <table width="100%">
            <td style="padding: 5px;">
              ...
              <h5> applying for tyhe corresponding BUSINESS PERMIT that has beenfound to be:<br>
              __ COMPLAINT with the provisions of existing Barangay Ordinance, rules and regulations being enforced in this barangay;<br>
              __NON-COMPLAINT with the provisions of existing Barangay Ordinance, rulend regulations being enforced in this barangay;<br><br>
              In view of the foregoing, this barangay, thru the undersigned.<br>
              __ Interposes NO OBJECTION for the assuance of the corresponding Mayors Permit being applied for.<br>
              __ Recommendsfor the NON-ISSUANCE of the cooresponding Mayors Permit being applied for.<br>
              </h5>
              <table>
