...
$query = "SELECT * FROM tbl_clearance WHERE (form_status ='Approved' OR form_status ='Declined') AND date >= '$startOfWeek' AND date < '$endOfWeek'";
...
<h1 style="text-align:center">Weekly Barangay Clearance Report</h1>
...
$pdf = new Pdf();
$file_name = 'Weekly Report - Barangay Clearance -'.$today.'.pdf';
$pdf->loadHtml($html);
