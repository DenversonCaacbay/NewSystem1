...
$query = "SELECT * FROM tbl_rescert WHERE (form_status ='Approved' OR form_status ='Declined') AND  DATE_FORMAT(date, '%Y-%m') = '$currentMonth'";
...
<h1 style="text-align:center">Monthly Residency Report</h1>
...
$pdf = new Pdf();
 ...
 $file_name = 'Monthly Report - Residency -'.$today.'.pdf';
 $pdf->loadHtml($html);
