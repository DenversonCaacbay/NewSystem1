...
$query = "SELECT * FROM tbl_rescert WHERE (form_status ='Approved' OR form_status ='Declined') AND DATE_FORMAT(date, '%Y') = '$currentYear'";
...
<h1 style="text-align:center">Yearly Residency Report</h1>
...
//landscape orientation
 $file_name = 'Yearly Report - Residency -'.$today.'.pdf';
 $pdf->loadHtml($html);
