...
$query = "SELECT * FROM tbl_rescert WHERE (form_status ='Approved' OR form_status ='Declined') AND date >= '$startOfWeek' AND date < '$endOfWeek'";
...
<h1 style="text-align:center">Weekly Residency Report</h1>
...
$pdf = new Pdf();
$file_name = 'Weekly Report - Residency -'.$today.'.pdf';
$pdf->loadHtml($html);
