        ...
        <div class="right">
          ...
          <table width="100%">
            <td style="padding: 5px;">
                ...
                <h5 style="text-indent: 50px; text-align: justify;"> This is to CERTIFY that ' . $result["lname"] . ', ' . $result["fname"] . ' ' . $result["mi"] . ', bonofide resident of this barangay with the address of ' . $result["street"] . ' STA. RITA, Olongapo City belongs to an indigent family.
                </h5>
                <h5 style="text-indent: 50px; text-align: justify;">
                This further certified that requestor has no permanent source of incom and could hardly sufficeher/his daily needs, Furthermore, she/he belongs to indigent families of this Barangay.
                </h5>
                <h5 style="text-indent: 50px; text-align: justify;">
              ...
              <table>
                  ...
                  <br>
                  <table>
                    <tr><td>DATE ISSUED: '.date("F d, Y", strtotime($today)).'</td></tr>
                    <tr><td>VALID UNTIL: '. date("F d, Y", strtotime($validUntil)) . '</td></tr>
                    <tr><td>RESIDENT NO: RES-037107015-'.$result["track_id"].'</td></tr>
                    <tr><td>DOCUMENT NO: KHO-037107015'.$result["track_id"].'</td></tr>
                  </table> 
              </table>
            </td>
            <td>
