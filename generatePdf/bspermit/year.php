...
$query = "SELECT * FROM tbl_bspermit WHERE (form_status ='Approved' OR form_status ='Declined') AND DATE_FORMAT(date, '%Y') = '$currentYear'";
...
<h1 style="text-align:center">Yearly Business Recommendation Report</h1>
...
//landscape orientation
 $file_name = 'Yearly Report - Business Recommendation -'.$today.'.pdf';
 $pdf->loadHtml($html);
