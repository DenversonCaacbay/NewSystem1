...
$query = "SELECT * FROM tbl_bspermit WHERE (form_status ='Approved' OR form_status ='Declined') AND date >= '$startOfWeek' AND date < '$endOfWeek'";
...
<h1 style="text-align:center">Weekly Business Recommendation Report</h1>
...
$pdf = new Pdf();
$file_name = 'Weekly Report - Business Recommendation -'.$today.'.pdf';
$pdf->loadHtml($html);
