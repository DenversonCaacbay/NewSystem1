...
$query = "SELECT * FROM tbl_bspermit WHERE form_status='Approved' AND created_at >= '$startOfWeek' AND created_at < '$endOfWeek'";
...
<h4>Document Type: Business Recommendation</h4>';
