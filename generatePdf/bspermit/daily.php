...
$query = "SELECT * FROM tbl_bspermit WHERE (form_status ='Approved' OR form_status ='Declined') AND DATE(created_at) = '$today' ";
...
<h1 style="text-align:center">Daily Business Recommendation Report</h1>
...
$pdf = new Pdf();
$file_name = 'Daily Report - Business Recommendation' . $today . '.pdf';
