...
$query = "SELECT * FROM tbl_bspermit WHERE (form_status ='Approved' OR form_status ='Declined') AND  DATE_FORMAT(date, '%Y-%m') = '$currentMonth'";
...
<h1 style="text-align:center">Monthly Business Recommendation Report</h1>
...
$pdf = new Pdf();
 ...
 $file_name = 'Monthly Report - Business Recommendation -'.$today.'.pdf';
 $pdf->loadHtml($html);
