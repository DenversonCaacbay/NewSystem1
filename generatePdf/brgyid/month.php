...
$query = "SELECT * FROM tbl_brgyid WHERE (form_status ='Approved' OR form_status ='Declined') AND  DATE_FORMAT(date, '%Y-%m') = '$currentMonth'";
...
<h1 style="text-align:center">Monthly Barangay ID Report</h1>
...
$pdf = new Pdf();
 ...
 $file_name = 'Monthly Report - Barangay ID-'.$today.'.pdf';
 $pdf->loadHtml($html);
