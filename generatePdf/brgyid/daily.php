...
$query = "SELECT * FROM tbl_brgyid WHERE (form_status ='Approved' OR form_status ='Declined') AND DATE(created_at) = '$today' ";
...
<h1 style="text-align:center">Daily Barangay ID Report</h1>
...
$pdf = new Pdf();
$file_name = 'Daily Report - Barangay ID' . $today . '.pdf';
