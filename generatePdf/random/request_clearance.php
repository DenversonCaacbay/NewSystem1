...
$query = "SELECT * FROM tbl_clearance WHERE (form_status = 'Approved' OR form_status = 'Declined') AND date BETWEEN '$fromDate' AND '$toDate'";
...
if ($result->num_rows > 0) {
    ...
    <body>
        <h1 style="text-align:center">Barangay Clearance Request Report</h1>
    ...
    $file_name = 'Barangay_Clearance_Request_Report-All_From_' . date('F_d_Y', strtotime($fromDate)) . '_To_' . date('F_d_Y', strtotime($toDate)) .'.pdf';
