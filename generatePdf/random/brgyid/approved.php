...
$query = "SELECT * FROM tbl_brgyid WHERE (form_status = 'Approved') AND date BETWEEN '$fromDate' AND '$toDate'";
...
if ($result->num_rows > 0) {
    ...
    $file_name = 'Barangay_ID_Request_Report-Approved_From_' . date('F_d_Y', strtotime($fromDate)) . '_To_' . date('F_d_Y', strtotime($toDate)) .'.pdf';
