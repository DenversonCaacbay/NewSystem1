...
$query = "SELECT * FROM tbl_indigency WHERE (form_status = 'Declined') AND date BETWEEN '$fromDate' AND '$toDate'";
...
if ($result->num_rows > 0) {
    ...
    $file_name = 'Indigency_Request_Report-Declined_From_' . date('F_d_Y', strtotime($fromDate)) . '_To_' . date('F_d_Y', strtotime($toDate)) .'.pdf';
