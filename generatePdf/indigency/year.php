...
$query = "SELECT * FROM tbl_indigency WHERE (form_status ='Approved' OR form_status ='Declined') AND DATE_FORMAT(date, '%Y') = '$currentYear'";
...
<h1 style="text-align:center">Yearly Indigency Report</h1>
...
//landscape orientation
 $file_name = 'Yearly Report - Indigency -'.$today.'.pdf';
 $pdf->loadHtml($html);
