...
//    $view = $bmis->view_bspermit_done();
   ...
   $view_all = $bmis->view_bspermit_done_all();
   $view_approved = $bmis->view_bspermit_done_approved();
   $view_declined = $bmis->view_bspermit_done_declined();
    ...
    <div class="row">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="d-flex align-items-center">
                ...
                <h4 class="ms-2 mt-2">Archives Business Recommendation</h4>
            </div>
            <div class="tab">
        ...
        <div class="row"> 
            <div class="col"> 
                <div class="card" style="height:450px; overflow: auto;">
                    <?php 
                        include('tables/bspermit/all.php');
                    ?>
                </div>
            </div>
        </div>
    ...
    <div id="Paris" class="tabcontent">
        <div class="row mt-3"> 
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-7">
                    <form id="pdfFormApproved" method="post" action="generatepdf/random/request_bspermit.php" target="_blank" style="display: inline-block; margin-right: 10px;">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group" style="margin-bottom: 5px;">
                                    <label for="fromDate" style="display: block;">From Date:</label>
                    ...
                    <div class="col-md-5">
                        ...
                        <select class="form-select mt-2" id="pdfGenerateSelect1">
                            <option value="">View Options</option>
                            <option value="generatePdf/bspermit/daily_approved.php">Daily</option>
                            <option value="generatePdf/bspermit/week_approved.php">Weekly</option>
                            <option value="generatePdf/bspermit/month_approved.php">Monthly</option>
                            <option value="generatePdf/bspermit/year_approved.php">Yearly</option>
                        </select>
                    </div>  
                </div>
            </div>
        ...
        <div class="row"> 
            <div class="col"> 
                <div class="card" style="height:450px; overflow: auto;">
                    <?php 
                        include('tables/bspermit/approved.php');
                    ?>
                </div>
            </div>
        </div>
    ...
    <div id="Tokyo" class="tabcontent">
        <div class="row mt-3"> 
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-7">
                    <form id="pdfFormDeclined" method="post" action="generatepdf/random/request_bspermit.php" target="_blank" style="display: inline-block; margin-right: 10px;">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group" style="margin-bottom: 5px;">
                                    <label for="fromDate" style="display: block;">From Date:</label>
                    ...
                    <div class="col-md-5">
                        ...
                        <select class="form-select mt-2" id="pdfGenerateSelect2">
                            <option value="">View Options</option>
                            <option value="generatePdf/bspermit/daily_declined.php">Daily</option>
                            <option value="generatePdf/bspermit/week_declined.php">Weekly</option>
                            <option value="generatePdf/bspermit/month_declined.php">Monthly</option>
                            <option value="generatePdf/bspermit/year_declined.php">Yearly</option>
                        </select>
                    </div>  
                </div>
            </div>
        ...
        <div class="row"> 
            <div class="col"> 
                <div class="card" style="height:450px; overflow: auto;">
                    <?php 
                        include('tables/bspermit/declined.php');
                    ?>
                </div>
            </div>
        </div>
