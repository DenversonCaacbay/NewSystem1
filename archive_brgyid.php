    ...
    <div class="row mt-3"> 
            ...
            <form method="POST" action="" id="searchForm">
                <div class="input-icons d-flex">
                    ...
                    Export Data By: 
                    <a class="btn btn-primary ms-2" target="_blank" href="generatePdf/brgyid/week.php">Week</a>
                    <a class="btn btn-primary ms-2" target="_blank" href="generatePdf/brgyid/month.php">Monthly</a>
                    <a class="btn btn-primary ms-2" target="_blank" href="generatePdf/brgyid/year.php">Yearly</a>
                </div>
            </form>
        </div>
