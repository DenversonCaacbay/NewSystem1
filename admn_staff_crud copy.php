                        ...
                        <?php if(is_array($view)) {?>
                            <?php foreach($view as $viewItem) {?>
                                <tr>
                                    ...
                                    <td>
                                    <?php if($viewItem['position'] !== 'Super Administrator'): ?>
                                        <?php if( $userdetails['position'] == 'Super Administrator'): ?>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" class="was-validated" autocomplete="off"> 
                                                        ...
                                                        <button class="btn btn-primary w-100 mt-3 p-2" type="submit" name="change_password" id="submit-button" style="border-radius:10px;" disabled> Change Passwords </button>  
                                                    </form>    
                                                </div>
                                                </div>
                                            </div>
