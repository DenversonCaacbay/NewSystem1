...
<div class="container-fluid page--container">
    ...
    <div class="d-flex justify-content-between mb-3">
        <h4 class="mb-0">Pending Barangay Clearance Requests</h4>
        <div class="d-flex align-items-center">
            <a href="./archive_clearance.php" class="me-3">View Archive</a>
            <a href="walkin_clearance.php" class="btn btn-primary"><i class="fas fa-walking me-2"></i>For Walk'in </a>
        </div>
    ...
    <div class="row"> 
        ...
        <form method="POST" action="">
                    <div class="input-icons w-100 d-flex">
                        ...
                        <button class="btn btn-success ms-3" name="search_clearance" >Search</button>
                        <a href="admn_brgyclearance.php" class="btn btn-info ms-3" >Reload</a>
                    </div>
                </form>
        </div>
    </div>
