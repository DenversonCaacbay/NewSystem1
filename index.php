...
.btn-primary:focus {
    ...
    <body> 
        ...
        <nav class="navbar navbar-dark bg-primary sticky-top">
            ...
            <a href="#down2" data-toggle="tooltip" title="Announcement" class="btn1"><i class="fa fa-bullhorn fa-lg"></i></a>
            <a href="#down1" data-toggle="tooltip" title="E-Services" class="btn2"><i class="fa fa-edit fa-lg"></i></a>
            <a href="#down" data-toggle="tooltip" title="Contact" class="btn3"><i class="fa fa-phone fa-lg"></i></a>
            
           
            <div class="dropdown ml-auto">
    <?php if (empty($userdetails)) : ?>
        <a href="login.php" class="btn btn-primary" style="margin-right: 2px;">Login</a>
        <a href="resident_registration.php" class="btn btn-primary" style="margin-right: 2px;">Create an Account</a>
    <?php else : ?>
