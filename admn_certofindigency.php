...
<div class="container-fluid page--container">
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <div class="d-flex align-items-center">
            <a href="./archive_indigency.php" class="me-3">View Archive</a>
            <a href="walkin_certofindigency.php" class="btn btn-primary"><i class="fas fa-walking me-2"></i>For Walk'in </a>
        </div>
