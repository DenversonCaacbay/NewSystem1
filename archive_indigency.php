    ...
    <div class="col">
            <form method="POST" action="" id="searchForm">
                <div class="input-icons d-flex">
                    ...
                    Export Data By: 
                    <a class="btn btn-primary ms-2" target="_blank" href="generatePdf/indigency/week.php">Week</a>
                    <a class="btn btn-primary ms-2" target="_blank" href="generatePdf/indigency/month.php">Monthly</a>
                    <a class="btn btn-primary ms-2" target="_blank" href="generatePdf/indigency/year.php">Yearly</a>
                </div>
            </form>
        </div>
