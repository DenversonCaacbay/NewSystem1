		...
		<tbody>
			...
			<tr>
                ...
                <td>
                    ...
                    <?php else: ?>
                        <button class="btn btn-success" data-toggle="modal" data-target="#imageModal<?= $view['id_blotter'] ?>">View</button>
                
                        <div class="modal fade" id="imageModal<?= $view['id_blotter'] ?>" tabindex="-1" role="dialog" aria-labelledby="imageModalTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <a href="<?= $view['blot_photo'] ?>" target="_blank"><img src="<?= $view['blot_photo'] ?>" class="img-fluid" alt="Modal Image"></a>
                                    </div>
		...
		<?php if(is_array($view)) {?>
			...
			<tr>
                ...
                <td>    
                    ...
                    <a class="btn btn-success" style="width: 90px; font-size: 17px; border-radius:30px; margin-bottom: 2px;" href="update_blotter_form.php?id_resident=<?= $view['id_resident'];?>">Update</a> 
                        <input type="hidden" name="id_blotter" value="<?= $view['id_blotter'];?>">
                        <button class="btn btn-danger" style="width: 90px; font-size: 17px; border-radius:30px;" type="submit" name="delete_blotter" onclick="return confirm('Are you sure you want to archive this data?')"> Archive </button>
                    </form>
                </td>
			</tr>
