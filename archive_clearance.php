...
//    $view = $bmis->view_clearance_done();
   ...
   $view_all = $bmis->view_clearance_done_all();
   $view_approved = $bmis->view_clearance_done_approved();
   $view_declined = $bmis->view_clearance_done_declined();
    ...
    <div class="row">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div class="d-flex align-items-center">
                ...
                <h4 class="ms-2 mt-2">Archives Barangay Clearance</h4>
            </div>
            <div class="tab">
        ...
        <div class="row"> 
            <div class="col"> 
                <div class="card" style="height:450px; overflow: auto;">
                    <?php 
                        include('tables/clearance/all.php');
                    ?>
                </div>
            </div>
        </div>
    ...
    <div id="Paris" class="tabcontent">
        ...
        <div class="row"> 
            <div class="col"> 
                <div class="card" style="height:450px; overflow: auto;">
                    <?php 
                        include('tables/clearance/approved.php');
                    ?>
                </div>
            </div>
        </div>
    ...
    <div id="Tokyo" class="tabcontent">
        ...
        <div class="row"> 
            <div class="col"> 
                <div class="card" style="height:450px; overflow: auto;">
                    <?php 
                        include('tables/clearance/declined.php');
                    ?>
                </div>
            </div>
        </div>
