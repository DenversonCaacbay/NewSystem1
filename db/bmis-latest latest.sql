...
--
-- Host: localhost
-- Generation Time: Apr 10, 2024 at 04:13 PM
...
CREATE TABLE `tbl_announcement` (
  ...
  `announcement_title` text COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `announcement_image` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `tbl_brgyid` (
  ...
  `track_id` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `id_resident` int NOT NULL,
  `lname` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `fname` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `mi` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `inc_municipal` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `form_status` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Pending',
...
CREATE TABLE `tbl_clearance` (
  ...
  `fname` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `mi` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `bdate` text COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `tbl_rescert` (
  ...
  `purpose` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `form_status` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Pending',
  `certofres_photo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `deleted_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_resident` (
  `id_resident` int NOT NULL,
  `res_photo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `valid_id_photo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `email` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `password` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `lname` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `fname` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `role` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `verified` varchar(255) COLLATE utf8mb4_general_ci DEFAULT 'Pending'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `tbl_announcement`
  MODIFY `id_announcement` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT for table `tbl_blotter`
--
ALTER TABLE `tbl_blotter`
  MODIFY `id_blotter` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `tbl_brgyid`
--
ALTER TABLE `tbl_brgyid`
  MODIFY `id_brgyid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `tbl_bspermit`
--
ALTER TABLE `tbl_bspermit`
  MODIFY `id_bspermit` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `tbl_clearance`
--
ALTER TABLE `tbl_clearance`
  MODIFY `id_clearance` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT for table `tbl_indigency`
--
ALTER TABLE `tbl_indigency`
  MODIFY `id_indigency` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `tbl_rescert`
--
ALTER TABLE `tbl_rescert`
  MODIFY `id_rescert` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `tbl_resident`
--
ALTER TABLE `tbl_resident`
  MODIFY `id_resident` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
